...
public class UserActions extends Thread {
	...
	public synchronized void editItem() {
		...
		try {
			pstm = con.prepareStatement(sql);
			pstm.setString(1, "Título editado");
		...
		createLog(currentUser.username + " editou o item para Título editado.");
	...
	public synchronized void deleteItem() {		
		...
		createLog(currentUser.username + " deletou o item Título editado.");
